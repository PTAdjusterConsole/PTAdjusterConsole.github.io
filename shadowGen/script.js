...
function colorObject() {
  btn_boxshadow = '-5px -5px 16px var(--fancy-dark), 5px 5px 16px var(--fancy-light)';
...
function updateCSS() {
  ...
  boxShadow = shadowToggle.checked ?
  ...
  if (backgroundToggle.checked) {
    background = `linear-gradient(145deg, ${color4Display.value}, ${color3Display.value})`;
  } else {
